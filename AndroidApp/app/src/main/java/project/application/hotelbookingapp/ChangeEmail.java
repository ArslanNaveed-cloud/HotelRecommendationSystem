...
public class ChangeEmail extends AppCompatActivity {
    ...
    private void savechanges() {
        dialog = ProgressDialog.show(ChangeEmail.this, "Please Wait",
                "Loading Data...");
        dialog.show();

        final RequestQueue queue = Volley.newRequestQueue(ChangeEmail.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("500")) {
                                Snackbar.make(findViewById(android.R.id.content),"Lastname not updated", Snackbar.LENGTH_SHORT)
                                        .show();
                            }else if (status.equals("200")) {
                                Toast.makeText(ChangeEmail.this, "Email updated successfully", Toast.LENGTH_SHORT).show();waitforsometime();


                            }else if(status.equals("409")){
                                Toast.makeText(ChangeEmail.this, "Email Already exists \nTry a different one", Toast.LENGTH_SHORT).show();
                            }
    ...
    public void waitforsometime(){
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                Intent intent = new Intent(ChangeEmail.this,DashBoardActivity.class);
