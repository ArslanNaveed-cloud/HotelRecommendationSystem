...
public class ChangeLastName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name= UserInfoModel.getLastname();
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ChangeLastName.super.onBackPressed();
            }
        });
    }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (status.equals("500")) {
                                ...
                                Snackbar.make(findViewById(android.R.id.content),"Lastname Updated Successfully", Snackbar.LENGTH_LONG)
                                        .show();
                                waitforsometime();
    ...
    public void waitforsometime(){
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                Intent intent = new Intent(ChangeLastName.this,DashBoardActivity.class);
