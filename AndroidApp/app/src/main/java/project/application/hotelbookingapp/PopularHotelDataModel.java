...
public class PopularHotelDataModel {
    ...
    public PopularHotelDataModel(String hotel_name, String hotel_address, String hotel_city, String hotel_description, String hotel_coverimage, int hotel_id, JSONArray hotl_galleyimages) {
