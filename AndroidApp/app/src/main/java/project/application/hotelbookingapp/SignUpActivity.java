...
public class SignUpActivity extends AppCompatActivity {
    private TextInputEditText firstname,lastname,phonenum,email,password,repassword,profilepicture;
    private String fname,lname,phonenumber,email1,pass,repass,profilepic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_sign_up);
        ...
        if(!isConnected(SignUpActivity.this)){
            buildDialog2(SignUpActivity.this).show();
        }
