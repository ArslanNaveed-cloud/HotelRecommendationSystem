...
public class popularadaphter extends RecyclerView.Adapter<popularadaphter.popularviewholder> {
    private ArrayList<PopularHotelDataModel> arraylist;
    private Context context;
    private ArrayList<HotelRatingDataModel> modelArrayList;

    public popularadaphter(ArrayList<PopularHotelDataModel> arraylist, ArrayList<HotelRatingDataModel> modelArrayList) {
    ...
    public popularviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new popularadaphter.popularviewholder(view);
    }
